...
def runWSD2Experiment(train_coll, test_coll, lt, T_settings, labsHierarchy, cv,
                      out_fN, testColl_scoreClassLabels,
                      readSections, param=None,
                      predictionsDir=None, keepSections='default',
                      scoring=None):
    ...
    MLvl.print_precision_recall_fscore_support(lt.num2nom(y_true), lt.num2nom(y_pred), 
                                               out_fN, labels=lt.classes_ )
                                               #strini="\nTest Set", strend="\n")
    ...
    for wavF, annF, template_annF in test_coll[:]:
        ...
        MLvl.printWSD2_scores(wavF, true_annF=annF,
                              template_annF=template_annF,
                              WSD2_clf=clf, WSD2_feExFun=feExFun, lt=lt,
                              scoreClassLabels=testColl_scoreClassLabels, outF=out_fN,
                              strini=", ", strend="", m='auto',
                              #strini="\nTESTCOLL", strend="\n", m='auto',
        ...
        if predictionsDir:
            ...
            pT.WSD2predictAnnotations(wavF, template_annF, feExFun, lt, clf,
                                      outF=annFile_predict, readSections=readSections,

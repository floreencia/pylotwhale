...
class clfSettings:
    """class for binding sklearn classifiers
    with common hyperparameter values"""
...
param_grid_di = {"clf__kernel": ["linear"], "clf__C": pen_range}
...
pen_range = [0.1, 1.0, 10.0, 100]
param_grid_di = {"clf__C": pen_range, "clf__gamma": gamma_range}
...
random_forest = clfSettings(
    "rf", RandomForestClassifier(max_depth=None, bootstrap=True), param_grid_di
)

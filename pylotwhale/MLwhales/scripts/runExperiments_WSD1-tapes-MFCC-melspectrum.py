...
test_coll = None
oDir = '/home/florencia/Desktop/TEST'
#'/home/flo/x1-flo/whales/MLwhales/whaleSoundDetector/data/experiments/tapes/'
...
param_grid = {'NFFT': [2**9],#, 2**10], 
              'n_mels' : [1,2,5,10,20,50,100], #np.hstack((np.arange(1, 10, 1), np.arange(10, 170, 20))),
